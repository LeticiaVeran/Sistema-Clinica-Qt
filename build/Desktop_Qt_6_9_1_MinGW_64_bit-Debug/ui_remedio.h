/********************************************************************************
** Form generated from reading UI file 'remedio.ui'
**
...
public:
    ...
    void setupUi(QDialog *Remedio)
    {
        if (Remedio->objectName().isEmpty())
            Remedio->setObjectName("Remedio");
        Remedio->resize(550, 280);
        tabWidget = new QTabWidget(Remedio);
        ...
        verticalLayoutWidget->setGeometry(QRect(60, 60, 201, 55));
        ...
        verticalLayoutWidget_2->setGeometry(QRect(60, 120, 201, 55));
        ...
        verticalLayoutWidget_4->setGeometry(QRect(280, 60, 181, 55));
        ...
        verticalLayoutWidget_3->setGeometry(QRect(280, 120, 181, 55));
        ...
        convenio_2 = new QLineEdit(verticalLayoutWidget_3);
        convenio_2->setObjectName("convenio_2");

        verticalLayout_3->addWidget(convenio_2);
        ...
        retranslateUi(Remedio);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(Remedio);
    } // setupUi

    void retranslateUi(QDialog *Remedio)
    {
        Remedio->setWindowTitle(QCoreApplication::translate("Remedio", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("Remedio", "Nome:", nullptr));
        label_3->setText(QCoreApplication::translate("Remedio", "Principio Ativo:", nullptr));
        crml->setText(QCoreApplication::translate("Remedio", "Forma Farmaceutica:", nullptr));
        novo_func->setText(QCoreApplication::translate("Remedio", "Novo Rem\303\251dio", nullptr));
        Alterar_d->setText(QCoreApplication::translate("Remedio", "Alterar Dados", nullptr));
        idlb->setText(QCoreApplication::translate("Remedio", "ID", nullptr));
        label_5->setText(QCoreApplication::translate("Remedio", "Dosagem:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("Remedio", "Tab 1", nullptr));
        label_8->setText(QCoreApplication::translate("Remedio", "Pesquisar por nome/principio ativo:", nullptr));
        pushButton_2->setText(QCoreApplication::translate("Remedio", "Listar", nullptr));
        label_7->setText(QCoreApplication::translate("Remedio", "Listar Rem\303\251dios", nullptr));
        pushButton->setText(QCoreApplication::translate("Remedio", "Listar", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("Remedio", "Tab 2", nullptr));
        label_4->setText(QCoreApplication::translate("Remedio", "Excluir Rem\303\251dio", nullptr));
        idlb_2->setText(QCoreApplication::translate("Remedio", "ID", nullptr));
        pushButton_3->setText(QCoreApplication::translate("Remedio", "Excluir", nullptr));
        label_9->setText(QCoreApplication::translate("Remedio", "Pesquisar por nome/principio ativo:", nullptr));
        pushButton_4->setText(QCoreApplication::translate("Remedio", "Listar", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("Remedio", "Page", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Remedio: public Ui_Remedio {};
} // namespace Ui
